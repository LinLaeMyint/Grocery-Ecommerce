...
background-image: url(image/snowbg4.gif);
    ...
    <div class="container">
		...
		<div class="row mb-3">
        	...
        	<div class="col-sm-5">
            	<input type="text" class="form-control" id="input" placeholder="Apple" value="" name="search">	
        	</div>
        	<div class="col -md-12 text-center">
        	<button type="submit" class="btn btn-dark"><i class="fas fa-search"></i></button>
        	<button type="submit" class="btn btn-dark" value="Show all Products"><i class="fas fa-eye">Show All</i></button>
...
?>
						...
						<?php if($result){
						 ...
						 <tr>
                            ...
                            <td class="actions">
            					<a href="Product_Edit.php?id=<?=$row['id']?>" class="edit" title="Edit Product"><i class="fas fa-edit"></i></a>
                                <a href="Product_Del.php?id=<?=$row['id']?>" class="remove" title="Remove Product"><i class="fas fa-trash-alt"></i></a>
                            </td>
            			</tr>
            			<?php endforeach; ?> 
            			<?php }	?>
