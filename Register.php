...
if ($statement1->rowCount() > 0) {
    ...
    if ($_POST["usrpassword"] == $_POST["usrrepeatpassword"]) {
        try {
            $sql="INSERT INTO users(username,email,password,role) VALUE(?,?,?,?)";
            $stmt=$db1->prepare($sql);
            $stmt->execute([$usrname,$usremail,$usrpsw,$usrrole]);
            ...
            <div class="card-body p-5">
              ...
              <form method="POST">
                ...
                <div class="form-outline mb-4">
                  <input type="text" id="usrname" class="form-control form-control-lg" name="username" placeholder="Ma Ma" required/>
                  <label class="form-label" for="usrname">Your Name</label>
                </div>

                <div class="form-outline mb-4">
                  <input type="email" id="usremail" class="form-control form-control-lg" name="email" placeholder="Yourname@gmail.com" required/>
                  <label class="form-label" for="usrname">Your Email</label>
                </div>

                <div class="form-outline mb-4">
                  <input type="password" id="usrpassword" class="form-control form-control-lg" name="usrpassword" required />
                  <label class="form-label" for="usrpassword">Password</label>
                </div>

                <div class="form-outline mb-4">
                  <input type="password" id="usrrepeatpassword" class="form-control form-control-lg" name="usrrepeatpassword"  />
                  <label class="form-label" for="usrrepeatpassword">Repeat your password</label>
                </div>
                
<!--                 <div class="form-outline mb-4"> -->
<!--                   <input type="text" id="usrrole" class="form-control form-control-lg" name="role"  disabled value="User"/> -->
...
<!--                 </div> -->
                ...
                <p class="text-center text-muted mt-5 mb-0">Have already an account? <a href="UserLogin.php" class="fw-bold text-body"><u>Login here</u></a></p>
