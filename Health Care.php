...
<div class="col-lg-9 center-block">
 				...
 				<form class="d-flex" method="POST" action="Health Care.php">
 				<label for="name" class="col-sm-4 col-form-label text-center">Search Product</label>
                    <div class="input-group">
                        <input type="text" class="form-control" placeholder="Search" name="searchhealth">
  ...
  <div class="row cat ">
    ...
    <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
    	...
    	<ul class="list-group">
    		...
    		<b><a href="Health Care.php" style="text-decoration:none;color:black">Show all categories</a></b>
    	</li>
    
   
    	<?php                           
                            $sql='SELECT * From category Where main_cat_id=4';
                            ...
                            if($result){
                                foreach ($result as $rows){?>
                                	<li style="list-style:none" class="list-group-item">
                                		<a href="Health Care.php?Category_ID=<?php echo $rows['Category_ID']?>" style="text-decoration:none;">
   ...
   if(isset($_POST['searchhealth'])){?>
       <?php  $search=$_POST['searchhealth'];
        $sql="SELECT * FROM product WHERE description like '%$search%' AND main_cat_id=4";
...
<div class="col-lg-9 col-md-9 col-sm-12 mx-auto">
    ...
    <?php }else{
        ...
        if (isset($_GET['Category_ID'])) {
            ...
            $result="SELECT * FROM product WHERE Category_ID=$cat_id AND main_cat_id=4";
            $resproductall=$db1->query($result);
        }
        else
        {
            $result="SELECT * FROM product WHERE main_cat_id=4";
            $resproductall=$db1->query($result);
