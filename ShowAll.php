...
/*    body{ */
/*   background-image: linear-gradient(#F194B4,yellow);  */
  ...
  <div class="row cat ">
    ...
    <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
    	...
    	<ul class="list-group">
    		...
    		<b><a href="ShowAll.php" style="text-decoration:none;color:black">Show all categories</a></b>
    	</li>
                            ...
                            if($result){
                                foreach ($result as $rows){?>
                                	<li style="list-style:none" class="list-group-item">
                                		<a href="ShowAll.php?Category_ID=<?php echo $rows['Category_ID']?>" style="text-decoration:none;">
